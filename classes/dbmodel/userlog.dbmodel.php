 ...
 */
class UserLogDbModel extends DbModel{

    const MC_USER_LOG_INFO = 'MC_USER_LOG_LIST_info_';

    const MC_USER_LOG_LIST = 'MC_USER_LOG_LIST_list';

    protected $_tableName = 'info_user_log';
...
//        Mcache::delete(self::MC_USER_LOG_LIST);
...
//        Mcache::delete(self::MC_USER_LOG_INFO . $id);
//        Mcache::delete(self::MC_USER_LOG_LIST);
        $where = "`id` = '".$id."'";
...
//        $data = Mcache::get(self::MC_USER_LOG_INFO . $id);
//        if(!$data || $real){
...
//        }
    ...
    public function getReal($id){
        ...
        if($data){
//            Mcache::set(self::MC_USER_LOG_INFO . $id, $data);
        }
        return $data;
    }
...
//        $data = Mcache::get(self::MC_USER_LOG_LIST);
//        if ($real || !$data){
...
//        }
    ...
    public function getListReal() {
        ...
        if ($data) {
//            Mcache::set(self::MC_USER_LOG_LIST, $data);
        }
        return $data;
    }
    ...
    public function cleanMc(){
        ...
        foreach( $list as $value ){
//            Mcache::delete(self::MC_USER_LOG_INFO . $value['id']);
        }
//        Mcache::delete(self::MC_USER_LOG_LIST);
        return $list;
    }

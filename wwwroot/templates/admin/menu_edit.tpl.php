                ...
                <form class="form-horizontal" action="<?php echo ADMIN_URL?>menu/edit/" method="post">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-large search-query" name="name" value="<?php echo $blogMenu['name'];?>">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="input01">seo-title: </label>
                            <div class="controls">
                                <input type="text" class="input-large search-query" name="seo_title" value="<?php echo $blogMenu['seo_title'];?>">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="input01">seo-description: </label>
                            <div class="controls">
                                <input type="text" class="input-large search-query" name="seo_description" value="<?php echo $blogMenu['seo_description'];?>">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="input01">seo-keywords: </label>
                            <div class="controls">
                                <input type="text" class="input-large search-query" name="seo_keywords" value="<?php echo $blogMenu['seo_keywords'];?>">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div id="out" style="display:none">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-large search-query" name="url" value="<?php echo $blogMenu['url'];?>">
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
